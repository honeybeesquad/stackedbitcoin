...
<head>
  ...
  <% require themedCSS('stacked') %>
  <link rel="icon" type="image/png" href="$ThemeDir/images/stacked-button-teal.png">
  <link rel="apple-touch-icon" href="$ThemeDir/images/stacked-button-teal.png">
</head>
<body>
  <header class="site-header">
    <div class="container">
      <div class="header-inner">
        <a href="$BaseHref" class="site-logo">
          <img src="$ThemeDir/images/stacked-logo-wide-teal.png" alt="Stacked" class="site-logo-desktop">
          <img src="$ThemeDir/images/stacked-button-teal.png" alt="Stacked" class="site-logo-mobile">
        </a>
  ...
  <nav class="mobile-menu-drawer" id="mobile-menu-drawer" aria-hidden="true">
    <div class="mobile-menu-section">
      ...
      <a href="/company" class="mobile-menu-link">Company</a>
      <a href="/wallet" class="mobile-menu-link">Wallet</a>
    ...
    <div class="mobile-menu-section">
      ...
      <a href="/register" class="mobile-menu-link">Get Started</a>
    </div>
  </nav>
      ...
      <div class="footer-grid">
        <div class="footer-column">
          ...
          <ul class="footer-links">
            <li><a href="/solutions/savers">Bitcoin for Savers</a></li>
            <li><a href="/solutions/businesses">Bitcoin for Businesses</a></li>
