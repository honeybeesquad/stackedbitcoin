...
const HeroSection = () => {
  ...
  return (
    <section id="wallet" className="pt-24 pb-12 md:pt-32 md:pb-16 lg:pt-40 lg:pb-24 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-3 mb-4 md:mb-6 justify-center">
            ...
            <button
              type="submit"
              aria-label="Get started with Stacked using your email"
          ...
          <span id="email-hint" className="sr-only">We'll send you a link to get started.</span>
