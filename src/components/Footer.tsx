    ...
    <footer className="py-10 md:py-12 bg-card border-t border-border">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Product */}
          <div>
            <h4 className="font-semibold text-primary mb-3 md:mb-4 text-sm md:text-base">Product</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="font-semibold text-primary mb-3 md:mb-4 text-sm md:text-base">Company</h4>
            <ul className="space-y-2 text-xs md:text-sm text-foreground">
